...
#define BE200_CP210X_SET_LINE_CTL 0x03
#define BE200_CP210X_CMD_LINE_CTL_VALUE 0x0841
#define BE200_CP210X_DATA_LINE_CTL_VALUE 0x0831
#define BE200_CP210X_VALUE_DATA 0x0000
#define BE200_CP210X_DATA_BAUD  460800L
#define BE200_CP210X_DATA_BAUD_2  115200L
...
#define USB_PARSE_COMMANDS(USB_ADD_COMMAND) \
	...
	USB_ADD_COMMAND(C_BE200_INIT, "BE200INIT") \
	USB_ADD_COMMAND(C_BE200_TASK, "BE200Task") \
	USB_ADD_COMMAND(C_BE200_READ, "BE200Read") \
	USB_ADD_COMMAND(C_GET_BE200_READY, "BE200Ready") \
	USB_ADD_COMMAND(C_BE200_RESET, "BE200Reset") \
	USB_ADD_COMMAND(C_GET_BE200_RESET, "GetBE200Reset") \
